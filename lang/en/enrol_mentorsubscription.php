...
$string['settings_mentor_plan_profile_field']       = 'Mentor plan value(s)';
$string['settings_mentor_plan_profile_field_desc']  = 'One or more option values (comma-separated) that identify a user as a mentor. E.g. <code>mentor</code> or <code>mentor,b2b</code>. Users whose profile field matches any of these values will have access to mentor features.';
...
$string['mentee_create_success']           = 'New mentee account created and assigned successfully.';
...
$string['mentee_create_set_password']      = 'Set password manually';
$string['mentee_create_alert_set_password']  = 'If the email address does not exist or is not real, you must set a password manually so the mentee can log in.';
$string['mentee_create_alert_auto_password'] = 'A password will be automatically generated and sent to the user by email with their username and login link.';
...
// -------------------------------------------------------------------------
$string['status']      = 'Allow enrolments';
$string['status_help'] = 'When disabled, this plugin will not enrol new users in this course and existing enrolments will be suspended.';
